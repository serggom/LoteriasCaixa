...
# Dupla-Sena
# Dados obtidos do endereço: http://loterias.caixa.gov.br/wps/portal/loterias/landing/duplasena
...
def duplasena():
    ...
    print('\n\033[1;36m Palpite: \033[0;0m ', ' - '.join(map(str, dusena())))
    if jogos > 1:
